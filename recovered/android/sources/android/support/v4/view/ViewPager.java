        ...
        switch (action & 255) {
            ...
            case 2:
                if (!this.mIsBeingDragged) {
                    ...
                    int activePointerIndex3 = MotionEventCompat.findPointerIndex(ev, this.mActivePointerId);
                    float x5 = MotionEventCompat.getX(ev, activePointerIndex3);
            ...
            case 5:
                ...
                float x6 = MotionEventCompat.getX(ev, index);
