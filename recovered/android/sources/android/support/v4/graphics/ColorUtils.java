...
public class ColorUtils {
    ...
    public static void RGBToHSL(@IntRange(from = 0, m1to = 255) int r, @IntRange(from = 0, m1to = 255) int g, @IntRange(from = 0, m1to = 255) int b, @NonNull float[] hsl) {
        float h;
        float s;
        float rf = r / 255.0f;
        float gf = g / 255.0f;
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int color, @IntRange(from = 0, m1to = 255) int alpha) {
