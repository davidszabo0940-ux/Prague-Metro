        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    IMediaBrowserServiceCompatCallbacks _arg3 = IMediaBrowserServiceCompatCallbacks.Stub.asInterface(data.readStrongBinder());
                    connect(_arg0, _arg2, _arg3);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    IMediaBrowserServiceCompatCallbacks _arg4 = IMediaBrowserServiceCompatCallbacks.Stub.asInterface(data.readStrongBinder());
                    disconnect(_arg4);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg5 = data.readString();
                    IMediaBrowserServiceCompatCallbacks _arg6 = IMediaBrowserServiceCompatCallbacks.Stub.asInterface(data.readStrongBinder());
                    addSubscription(_arg5, _arg6);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg7 = data.readString();
                    IMediaBrowserServiceCompatCallbacks _arg8 = IMediaBrowserServiceCompatCallbacks.Stub.asInterface(data.readStrongBinder());
                    removeSubscription(_arg7, _arg8);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
