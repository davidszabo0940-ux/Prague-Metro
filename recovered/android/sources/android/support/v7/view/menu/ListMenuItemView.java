...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0178R.styleable.MenuView, defStyle, 0);
        this.mBackground = a.getDrawable(C0178R.styleable.MenuView_android_itemBackground);
        this.mTextAppearance = a.getResourceId(C0178R.styleable.MenuView_android_itemTextAppearance, -1);
        this.mPreserveIconSpacing = a.getBoolean(C0178R.styleable.MenuView_preserveIconSpacing, false);
    ...
    protected void onFinishInflate() {
        ...
        this.mTitleView = (TextView) findViewById(C0178R.id.title);
        if (this.mTextAppearance != -1) {
            this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
        }
        this.mShortcutView = (TextView) findViewById(C0178R.id.shortcut);
    }
    ...
    private void insertIconView() {
        ...
        this.mIconView = (ImageView) inflater.inflate(C0178R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        this.mRadioButton = (RadioButton) inflater.inflate(C0178R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        this.mCheckBox = (CheckBox) inflater.inflate(C0178R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
