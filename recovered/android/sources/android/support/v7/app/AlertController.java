...
class AlertController {
    ...
    private final View.OnClickListener mButtonHandler = new View.OnClickListener() { // from class: android.support.v7.app.AlertController.1
        ...
        public void onClick(View v) {
            ...
            if (v != AlertController.this.mButtonPositive || AlertController.this.mButtonPositiveMessage == null) {
                if (v == AlertController.this.mButtonNegative && AlertController.this.mButtonNegativeMessage != null) {
                    m = Message.obtain(AlertController.this.mButtonNegativeMessage);
                } else {
                    m = (v != AlertController.this.mButtonNeutral || AlertController.this.mButtonNeutralMessage == null) ? null : Message.obtain(AlertController.this.mButtonNeutralMessage);
                }
            } else {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0178R.styleable.AlertDialog, C0178R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0178R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0178R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0178R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0178R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0178R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0178R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    }
    ...
    private void setupView() {
        View spacer;
        View parentPanel = this.mWindow.findViewById(C0178R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0178R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0178R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0178R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0178R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0178R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0178R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0178R.id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null && (spacer = contentPanel.findViewById(C0178R.id.textSpacerNoButtons)) != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0178R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0178R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0178R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            View titleTemplate = this.mWindow.findViewById(C0178R.id.title_template);
        ...
        if (hasTextTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0178R.id.alertTitle);
        ...
        View titleTemplate2 = this.mWindow.findViewById(C0178R.id.title_template);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0178R.id.scrollView);
