...
class TwilightCalculator {
    ...
    private static final float f14C1 = 0.0334196f;

    /* JADX INFO: renamed from: C2 */
    private static final float f15C2 = 3.49066E-4f;

    /* JADX INFO: renamed from: C3 */
    private static final float f16C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* JADX INFO: renamed from: J0 */
    private static final float f17J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long time, double latiude, double longitude) {
        ...
        double trueAnomaly = ((double) meanAnomaly) + (0.03341960161924362d * Math.sin(meanAnomaly)) + (3.4906598739326E-4d * Math.sin(2.0f * meanAnomaly)) + (5.236000106378924E-6d * Math.sin(3.0f * meanAnomaly));
        double solarLng = 1.796593063d + trueAnomaly + 3.141592653589793d;
        double arcLongitude = (-longitude) / 360.0d;
        float n = Math.round(((double) (daysSince2000 - f17J0)) - arcLongitude);
        double solarTransitJ2000 = ((double) (f17J0 + n)) + arcLongitude + (0.0053d * Math.sin(meanAnomaly)) + ((-0.0069d) * Math.sin(2.0d * solarLng));
