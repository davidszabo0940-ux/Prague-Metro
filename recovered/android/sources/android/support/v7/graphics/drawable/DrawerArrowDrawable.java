...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0178R.styleable.DrawerArrowToggle, C0178R.attr.drawerArrowStyle, C0178R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0178R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C0178R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C0178R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize(Math.round(a.getDimension(C0178R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0178R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = Math.round(a.getDimension(C0178R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = Math.round(a.getDimension(C0178R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C0178R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(bounds.centerX(), (float) (((double) yOffset) + (((double) barThickness) * 1.5d) + ((double) this.mBarGap)));
        if (this.mSpin) {
    ...
    @FloatRange(from = 0.0d, m0to = 1.0d)
    public float getProgress() {
        return this.mProgress;
    }

    public void setProgress(@FloatRange(from = 0.0d, m0to = 1.0d) float progress) {
