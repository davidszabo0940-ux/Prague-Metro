...
class AppCompatTextHelper {
    ...
    private static final int[] TEXT_APPEARANCE_ATTRS = {C0178R.attr.textAllCaps};
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        if (ap != -1) {
            TypedArray appearance = context.obtainStyledAttributes(ap, C0178R.styleable.TextAppearance);
            if (appearance.hasValue(C0178R.styleable.TextAppearance_textAllCaps)) {
                setAllCaps(appearance.getBoolean(C0178R.styleable.TextAppearance_textAllCaps, false));
            }
            appearance.recycle();
        }
