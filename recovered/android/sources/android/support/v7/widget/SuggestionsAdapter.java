...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ImageView iconRefine = (ImageView) v.findViewById(C0178R.id.edit_query);
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0178R.id.edit_query);
        }
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (views.mText2 != null) {
            CharSequence text3 = getStringOrNull(cursor, this.mText2UrlCol);
            if (text3 != null) {
                text2 = formatUrl(text3);
            } else {
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0178R.attr.textColorSearchUrl, colorValue, true);
