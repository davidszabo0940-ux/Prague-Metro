...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0178R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.widget.ActionBarOverlayLayout.1
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0178R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0178R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0178R.id.action_bar));
        }
    }
