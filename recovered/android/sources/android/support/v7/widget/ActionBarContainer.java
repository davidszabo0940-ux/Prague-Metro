...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        boolean z = true;
        Drawable bg = Build.VERSION.SDK_INT >= 21 ? new ActionBarBackgroundDrawableV21(this) : new ActionBarBackgroundDrawable(this);
        setBackgroundDrawable(bg);
        TypedArray a = context.obtainStyledAttributes(attrs, C0178R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0178R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0178R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0178R.styleable.ActionBar_height, -1);
        if (getId() == C0178R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0178R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0178R.id.action_bar);
        this.mContextView = findViewById(C0178R.id.action_context_bar);
    }
