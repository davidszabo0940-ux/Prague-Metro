...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0178R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0178R.styleable.SearchView, defStyleAttr, 0);
        this.mTintManager = a.getTintManager();
        LayoutInflater inflater = LayoutInflater.from(context);
        int layoutResId = a.getResourceId(C0178R.styleable.SearchView_layout, C0178R.layout.abc_search_view);
        inflater.inflate(layoutResId, (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0178R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0178R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0178R.id.search_plate);
        this.mSubmitArea = findViewById(C0178R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0178R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0178R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0178R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0178R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0178R.id.search_mag_icon);
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0178R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0178R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0178R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0178R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0178R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0178R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0178R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0178R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0178R.styleable.SearchView_suggestionRowLayout, C0178R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0178R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0178R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0178R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0178R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0178R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0178R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0178R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        boolean focusable = a.getBoolean(C0178R.styleable.SearchView_android_focusable, true);
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0178R.dimen.abc_search_view_preferred_width);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0178R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0178R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0178R.attr.autoCompleteTextViewStyle);
        }
