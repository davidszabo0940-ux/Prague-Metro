...
public interface zzef extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzef {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzef$zza$zza, reason: collision with other inner class name */
        private static class C0775zza implements zzef {
            ...
            public void zza(zzea zzeaVar) throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain.writeStrongBinder(zzeaVar != null ? zzeaVar.asBinder() : null);
        ...
        public static zzef zzaf(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzef)) ? new C0775zza(iBinder) : (zzef) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzea.zza.zzac(parcel.readStrongBinder()));
