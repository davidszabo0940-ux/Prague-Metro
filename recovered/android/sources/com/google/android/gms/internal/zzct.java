...
public class zzct {
    ...
    public static class zza {
        ...
        public boolean equals(Object obj) {
            ...
            return ((zza) obj).value == this.value && ((zza) obj).zzath == this.zzath;
        }
    ...
    static String zza(String[] strArr, int i, int i2) {
        if (strArr.length < i + i2) {
            zzkh.m14e("Unable to construct shingle");
            return "";
        }
    ...
    static void zza(int i, long j, String str, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        if ((priorityQueue.size() != i || (priorityQueue.peek().zzath <= zzaVar.zzath && priorityQueue.peek().value <= zzaVar.value)) && !priorityQueue.contains(zzaVar)) {
    ...
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zza> priorityQueue) {
        ...
        while (i3 < (strArr.length - i2) + 1) {
            long jZza2 = zza(zzcr.zzac(strArr[i3 - 1]), zzcr.zzac(strArr[(i3 + i2) - 1]), jZzb, jZza, 16785407L);
    ...
    private static long zzb(String[] strArr, int i, int i2) {
        long jZzac = (((long) zzcr.zzac(strArr[i])) + 2147483647L) % 1073807359;
        for (int i3 = i + 1; i3 < i + i2; i3++) {
            jZzac = (((jZzac * 16785407) % 1073807359) + ((((long) zzcr.zzac(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZzac;
    }
}
