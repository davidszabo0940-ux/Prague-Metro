...
public final class zzdc {
    ...
    public static final zzcy<Boolean> zzaxx = zzcy.zza(0, "gads:request_builder:singleton_webview", (Boolean) false);
    public static final zzcy<String> zzaxy = zzcy.zza(0, "gads:request_builder:singleton_webview_experiment_id");
    public static final zzcy<Boolean> zzaxz = zzcy.zza(0, "gads:sdk_use_dynamic_module", (Boolean) true);
    public static final zzcy<String> zzaya = zzcy.zza(0, "gads:sdk_use_dynamic_module_experiment_id");
    public static final zzcy<Boolean> zzayb = zzcy.zza(0, "gads:sdk_crash_report_enabled", (Boolean) false);
    public static final zzcy<Boolean> zzayc = zzcy.zza(0, "gads:sdk_crash_report_full_stacktrace", (Boolean) false);
    public static final zzcy<String> zzayd = zzcy.zza(0, "gads:sdk_crash_report_class_prefix", "com.google.");
    public static final zzcy<Boolean> zzaye = zzcy.zza(0, "gads:block_autoclicks", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzayi = zzcy.zza(0, "gads:spam_app_context:enabled", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzayq = zzcy.zza(0, "gads:video:metric_reporting_enabled", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzayu = zzcy.zza(0, "gads:spam_ad_id_decorator:enabled", (Boolean) false);
    public static final zzcy<String> zzayv = zzcy.zzb(0, "gads:looper_for_gms_client:experiment_id");
    public static final zzcy<Boolean> zzayw = zzcy.zza(0, "gads:looper_for_gms_client:enabled", (Boolean) true);
    public static final zzcy<Boolean> zzayx = zzcy.zza(0, "gads:sw_ad_request_service:enabled", (Boolean) true);
    public static final zzcy<Boolean> zzayy = zzcy.zza(0, "gads:sw_dynamite:enabled", (Boolean) true);
    ...
    public static final zzcy<Boolean> zzazc = zzcy.zza(0, "gads:enabled_sdk_csi", (Boolean) false);
    public static final zzcy<String> zzazd = zzcy.zza(0, "gads:sdk_csi_server", "https://csi.gstatic.com/csi");
    public static final zzcy<Boolean> zzaze = zzcy.zza(0, "gads:sdk_csi_write_to_file", (Boolean) false);
    public static final zzcy<Boolean> zzazf = zzcy.zza(0, "gads:enable_content_fetching", (Boolean) true);
    ...
    public static final zzcy<Boolean> zzazl = zzcy.zza(0, "gad:app_index_enabled", (Boolean) true);
    public static final zzcy<Boolean> zzazm = zzcy.zza(0, "gads:app_index:without_content_info_present:enabled", (Boolean) true);
    ...
    public static final zzcy<Boolean> zzazq = zzcy.zza(0, "gads:kitkat_interstitial_workaround:enabled", (Boolean) true);
    public static final zzcy<Boolean> zzazr = zzcy.zza(0, "gads:interstitial_follow_url", (Boolean) true);
    public static final zzcy<Boolean> zzazs = zzcy.zza(0, "gads:interstitial_follow_url:register_click", (Boolean) true);
    public static final zzcy<String> zzazt = zzcy.zza(0, "gads:interstitial_follow_url:experiment_id");
    public static final zzcy<Boolean> zzazu = zzcy.zza(0, "gads:analytics_enabled", (Boolean) true);
    public static final zzcy<Boolean> zzazv = zzcy.zza(0, "gads:ad_key_enabled", (Boolean) false);
    public static final zzcy<Integer> zzazw = zzcy.zza(0, "gads:webview_cache_version", 0);
    public static final zzcy<Boolean> zzazx = zzcy.zza(1, "gads:webview_recycle:enabled", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzbab = zzcy.zza(0, "gads:ad_manager_creator:enabled", (Boolean) true);
    public static final zzcy<Boolean> zzbac = zzcy.zza(1, "gads:interstitial_ad_pool:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbad = zzcy.zza(1, "gads:interstitial_ad_pool:enabled_for_rewarded", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzban = zzcy.zza(0, "gads:log:verbose_enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbao = zzcy.zza(1, "gads:include_local_global_rectangles", (Boolean) false);
    public static final zzcy<String> zzbap = zzcy.zza(1, "gads:include_local_global_rectangles:experiment_id");
    public static final zzcy<Boolean> zzbaq = zzcy.zza(0, "gads:device_info_caching:enabled", (Boolean) true);
    public static final zzcy<Long> zzbar = zzcy.zza(0, "gads:device_info_caching_expiry_ms:expiry", 300000L);
    public static final zzcy<Boolean> zzbas = zzcy.zza(0, "gads:gen204_signals:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbat = zzcy.zza(0, "gads:webview:error_reporting_enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbau = zzcy.zza(0, "gads:adid_reporting:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbav = zzcy.zza(0, "gads:ad_settings_page_reporting:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbaw = zzcy.zza(0, "gads:adid_info_gmscore_upgrade_reporting:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbax = zzcy.zza(0, "gads:request_pkg:enabled", (Boolean) true);
    public static final zzcy<Boolean> zzbay = zzcy.zza(0, "gads:gmsg:disable_back_button:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbaz = zzcy.zza(0, "gads:gmsg:video_meta:enabled", (Boolean) true);
    ...
    public static final zzcy<Boolean> zzbbc = zzcy.zza(0, "gads:mediation:dynamite_first:admobadapter", (Boolean) true);
    public static final zzcy<Boolean> zzbbd = zzcy.zza(0, "gads:mediation:dynamite_first:adurladapter", (Boolean) true);
    ...
    public static final zzcy<Boolean> zzbbg = zzcy.zza(0, "gads:adshield:enable_adshield_instrumentation", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzbbj = zzcy.zza(1, "gads:gestures:encrypt_size_limit:enabled", (Boolean) true);
    public static final zzcy<String> zzbbk = zzcy.zza(1, "gads:gestures:cpu:experiment_id");
    public static final zzcy<Boolean> zzbbl = zzcy.zza(1, "gads:gestures:cpu_query:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbbm = zzcy.zza(1, "gads:gestures:cpu_click:enabled", (Boolean) false);
    public static final zzcy<String> zzbbn = zzcy.zza(1, "gads:gestures:jbk:experiment_id");
    public static final zzcy<Boolean> zzbbo = zzcy.zza(1, "gads:gestures:jbk_query:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbbp = zzcy.zza(1, "gads:gestures:jbk_click:enabled", (Boolean) false);
    public static final zzcy<String> zzbbq = zzcy.zza(1, "gads:gestures:stk:experiment_id");
    public static final zzcy<Boolean> zzbbr = zzcy.zza(1, "gads:gestures:stk:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbbs = zzcy.zza(0, "gass:client:enabled", (Boolean) false);
    public static final zzcy<String> zzbbt = zzcy.zza(0, "gass:client:experiment_id");
    public static final zzcy<Boolean> zzbbu = zzcy.zza(0, "gass:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbbv = zzcy.zza(0, "gass:enable_int_signal", (Boolean) true);
    public static final zzcy<Boolean> zzbbw = zzcy.zza(0, "gads:adid_notification:first_party_check:enabled", (Boolean) true);
    public static final zzcy<Boolean> zzbbx = zzcy.zza(0, "gads:edu_device_helper:enabled", (Boolean) true);
    public static final zzcy<Boolean> zzbby = zzcy.zza(0, "gads:support_screen_shot", (Boolean) true);
    public static final zzcy<Boolean> zzbbz = zzcy.zza(0, "gads:use_get_drawing_cache_for_screenshot:enabled", (Boolean) true);
    public static final zzcy<String> zzbca = zzcy.zza(0, "gads:use_get_drawing_cache_for_screenshot:experiment_id");
    public static final zzcy<Long> zzbcb = zzcy.zza(0, "gads:js_flags:update_interval", TimeUnit.HOURS.toMillis(12));
    public static final zzcy<Boolean> zzbcc = zzcy.zza(0, "gads:custom_render:ping_on_ad_rendered", (Boolean) false);
    public static final zzcy<Boolean> zzbcd = zzcy.zza(1, "gads:singleton_webview_native", (Boolean) false);
    public static final zzcy<String> zzbce = zzcy.zza(1, "gads:singleton_webview_native:experiment_id");
    public static final zzcy<Boolean> zzbcf = zzcy.zza(1, "gads:enable_untrack_view_native", (Boolean) true);
    public static final zzcy<Boolean> zzbcg = zzcy.zza(1, "gads:reset_listeners_preparead_native", (Boolean) true);
    public static final zzcy<Boolean> zzbch = zzcy.zza(0, "gads:method_tracing:enabled", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzbcl = zzcy.zza(1, "gads:auto_location_for_coarse_permission", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzbcr = zzcy.zza(1, "gads:fetch_app_settings_using_cld:enabled", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzbdc = zzcy.zza(0, "gads:afs:csa_ad_manager_enabled", (Boolean) true);
    public static final zzcy<Boolean> zzbdd = zzcy.zza(0, "gads:safe_browsing:reporting:malicious:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbde = zzcy.zza(0, "gads:safe_browsing:reporting:full:enabled", (Boolean) false);
    public static final zzcy<Boolean> zzbdf = zzcy.zza(0, "gads:safe_browsing:screenshot:enabled", (Boolean) false);
    ...
    public static final zzcy<Boolean> zzbdk = zzcy.zza(0, "gads:safe_browsing:debug", (Boolean) false);
    public static final zzcy<Boolean> zzbdl = zzcy.zza(0, "gads:webview_cookie:enabled", (Boolean) true);

    public static void initialize(final Context context) {
        zzkx.zzb(new Callable<Void>() { // from class: com.google.android.gms.internal.zzdc.1
            @Override // java.util.concurrent.Callable
            /* JADX INFO: renamed from: zzcy, reason: merged with bridge method [inline-methods] */
            public Void call() {
                com.google.android.gms.ads.internal.zzu.zzfz().initialize(context);
                return null;
            }
        });
    }
    ...
    public static List<String> zzjy() {
        return com.google.android.gms.ads.internal.zzu.zzfy().zzjy();
    }
}
