...
public interface zzeg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeg {
        ...
        /* JADX INFO: renamed from: com.google.android.gms.internal.zzeg$zza$zza, reason: collision with other inner class name */
        private static class C0776zza implements zzeg {
            ...
            public void zza(zzec zzecVar, String str) throws RemoteException {
        ...
        public static zzeg zzag(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzeg)) ? new C0776zza(iBinder) : (zzeg) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    zza(zzec.zza.zzad(parcel.readStrongBinder()), parcel.readString());
    ...
    void zza(zzec zzecVar, String str) throws RemoteException;
}
