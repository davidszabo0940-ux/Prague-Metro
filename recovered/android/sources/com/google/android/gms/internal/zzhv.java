...
public interface zzhv extends IInterface {

    public static abstract class zza extends Binder implements zzhv {

        /* JADX INFO: renamed from: com.google.android.gms.internal.zzhv$zza$zza, reason: collision with other inner class name */
        private static class C0792zza implements zzhv {
            private IBinder zzahn;

            C0792zza(IBinder iBinder) {
                this.zzahn = iBinder;
            }
        ...
        public static zzhv zzax(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzhv)) ? new C0792zza(iBinder) : (zzhv) iInterfaceQueryLocalInterface;
        }
