...
public class zzv implements com.google.android.gms.internal.zzb {
    ...
    private void zzc(int i) {
        ...
        while (true) {
            ...
            it.remove();
            i2 = i3 + 1;
            if (this.zzbx + ((long) i) < this.zzbz * 0.9f) {
                break;
            } else {
                i3 = i2;
            }
        ...
        if (zzs.DEBUG) {
            zzs.zza("pruned %d files, %d bytes, %d ms", Integer.valueOf(i2), Long.valueOf(this.zzbx - j), Long.valueOf(SystemClock.elapsedRealtime() - jElapsedRealtime));
        }
    }
                    ...
                    try {
                        ...
                        try {
                            try {
                                ...
                                zzaVarZzf.zzca = file.length();
                                zza(zzaVarZzf.zzcb, zzaVarZzf);
        ...
        if (zzaVar == null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        zza.zzf(zzbVar);
                        zzaVarZzb = zzaVar.zzb(zza(zzbVar, (int) (fileZzf.length() - ((long) zzbVar.zzcc))));
                        if (zzbVar != null) {
                            try {
                                zzbVar.close();
                            } catch (IOException e) {
