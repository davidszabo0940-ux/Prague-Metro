...
public final class DataBufferObserverSet implements DataBufferObserver, DataBufferObserver.Observable {
    ...
    private HashSet<DataBufferObserver> f177vJ = new HashSet<>();

    @Override // com.google.android.gms.common.data.DataBufferObserver.Observable
    public void addObserver(DataBufferObserver dataBufferObserver) {
        this.f177vJ.add(dataBufferObserver);
    }
    ...
    public boolean hasObservers() {
        return !this.f177vJ.isEmpty();
    }

    @Override // com.google.android.gms.common.data.DataBufferObserver
    public void onDataChanged() {
        Iterator<DataBufferObserver> it = this.f177vJ.iterator();
        while (it.hasNext()) {
    ...
    public void removeObserver(DataBufferObserver dataBufferObserver) {
        this.f177vJ.remove(dataBufferObserver);
    }
}
