...
public class zze {
    ...
    public static boolean f493rf = false;

    /* JADX INFO: renamed from: rg */
    public static boolean f494rg = false;

    /* JADX INFO: renamed from: rh */
    static boolean f495rh = false;

    /* JADX INFO: renamed from: ri */
    private static String f496ri = null;

    /* JADX INFO: renamed from: rj */
    private static int f497rj = 0;

    /* JADX INFO: renamed from: rk */
    private static boolean f498rk = false;

    /* JADX INFO: renamed from: rl */
    static final AtomicBoolean f499rl = new AtomicBoolean();

    /* JADX INFO: renamed from: rm */
    private static final AtomicBoolean f500rm = new AtomicBoolean();
    ...
    public static String getOpenSourceSoftwareLicenseInfo(Context context) {
        try {
            InputStream inputStreamOpenInputStream = context.getContentResolver().openInputStream(new Uri.Builder().scheme("android.resource").authority("com.google.android.gms").appendPath("raw").appendPath("third_party_licenses").build());
            try {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0228R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        try {
            ...
            zzf zzfVarZzbz = zzf.zzbz(context);
            if (z) {
                zzd.zza zzaVarZza = zzfVarZzbz.zza(packageInfo, zzd.C0753zzd.f492re);
                if (zzaVarZza == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (zzfVarZzbz.zza(packageInfo2, zzaVarZza) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                    return 9;
                }
            } else if (zzfVarZzbz.zza(packageInfo2, zzd.C0753zzd.f492re) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    private static int zzank() {
        return com.google.android.gms.common.internal.zze.f304xB;
    }
    ...
    public static void zzbb(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int iIsGooglePlayServicesAvailable = zzc.zzand().isGooglePlayServicesAvailable(context);
        if (iIsGooglePlayServicesAvailable != 0) {
            Intent intentZza = zzc.zzand().zza(context, iIsGooglePlayServicesAvailable, "e");
    ...
    private static void zzbs(Context context) {
        ...
        if (f497rj != GOOGLE_PLAY_SERVICES_VERSION_CODE) {
    ...
    public static boolean zzbw(Context context) {
        ...
        return zzs.zzavp() && (applicationRestrictions = ((UserManager) context.getSystemService("user")).getApplicationRestrictions(context.getPackageName())) != null && "true".equals(applicationRestrictions.getString("restricted_profile"));
    }
    ...
    private static void zzby(Context context) {
        try {
            f496ri = context.getPackageName();
            zzrt zzrtVarZzcq = zzru.zzcq(context);
            f497rj = zzz.zzcg(context);
            PackageInfo packageInfo = zzrtVarZzcq.getPackageInfo("com.google.android.gms", 64);
            if (packageInfo == null || zzf.zzbz(context).zza(packageInfo, zzd.C0753zzd.f492re[1]) == null) {
                f495rh = false;
            } else {
                f495rh = true;
            }
    ...
    static boolean zzm(Context context, String str) {
        if (str.equals("com.google.android.gms") && com.google.android.gms.common.util.zzd.zzabc()) {
            return false;
        }
        if (zzs.zzavs()) {
