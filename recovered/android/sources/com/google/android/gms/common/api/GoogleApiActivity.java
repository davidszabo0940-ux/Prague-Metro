...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    private void zza(int i, zzqh zzqhVar) {
        switch (i) {
            case -1:
                zzqhVar.zzaol();
                break;
            case 0:
                zzqhVar.zza(new ConnectionResult(13, null), getIntent().getIntExtra("failing_client_id", -1));
                break;
        }
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            this.f129rL = bundle.getInt("resolution");
        }
        if (this.f129rL != 1) {
            zzaoa();
        }
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("resolution", this.f129rL);
