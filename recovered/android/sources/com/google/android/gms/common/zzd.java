...
class zzd {
    ...
    private static zzv f484qW;

    /* JADX INFO: renamed from: qX */
    private static Context f485qX;

    /* JADX INFO: renamed from: qY */
    private static Set<zzs> f486qY;

    /* JADX INFO: renamed from: qZ */
    private static Set<zzs> f487qZ;
    ...
    static abstract class zza extends zzs.zza {
        ...
        protected zza(byte[] bArr) {
            if (bArr.length != 25) {
                ...
                String strValueOf = String.valueOf(zzm.zza(bArr, 0, bArr.length, false));
                ...
                zzab.zzb(bArr.length == 25, new StringBuilder(55).append("cert hash data has incorrect length. length=").append(bArr.length).toString());
            }
            this.f488ra = Arrays.hashCode(bArr);
        }
        ...
        public boolean equals(Object obj) {
            com.google.android.gms.dynamic.zzd zzdVarZzanh;
            if (obj == null || !(obj instanceof zzs)) {
                return false;
            }
            try {
                zzs zzsVar = (zzs) obj;
                if (zzsVar.zzani() == hashCode() && (zzdVarZzanh = zzsVar.zzanh()) != null) {
                    return Arrays.equals(getBytes(), (byte[]) com.google.android.gms.dynamic.zze.zzad(zzdVarZzanh));
                }
                return false;
        ...
        public com.google.android.gms.dynamic.zzd zzanh() {
            return com.google.android.gms.dynamic.zze.zzae(getBytes());
        }
    ...
    static abstract class zzc extends zza {
        ...
        private static final WeakReference<byte[]> f490rd = new WeakReference<>(null);

        /* JADX INFO: renamed from: rc */
        private WeakReference<byte[]> f491rc;
        ...
        byte[] getBytes() {
            byte[] bArrZzanj;
            synchronized (this) {
                bArrZzanj = this.f491rc.get();
                if (bArrZzanj == null) {
                    bArrZzanj = zzanj();
                    this.f491rc = new WeakReference<>(bArrZzanj);
                }
            }
            return bArrZzanj;
        }
    ...
    /* JADX INFO: renamed from: com.google.android.gms.common.zzd$zzd, reason: collision with other inner class name */
    static final class C0753zzd {

        /* JADX INFO: renamed from: re */
        static final zza[] f492re = {new zzc(zza.zzgw("0\u0082\u0004C0\u0082\u0003+ \u0003\u0002\u0001\u0002\u0002\t\u0000Âà\u0087FdJ0\u008d0")) { // from class: com.google.android.gms.common.zzd.zzd.1
        ...
        }, new zzc(zza.zzgw("0\u0082\u0004¨0\u0082\u0003\u0090 \u0003\u0002\u0001\u0002\u0002\t\u0000Õ\u0085¸l}ÓNõ0")) { // from class: com.google.android.gms.common.zzd.zzd.2
            @Override // com.google.android.gms.common.zzd.zzc
            protected byte[] zzanj() {
    ...
    private static Set<zzs> zza(IBinder[] iBinderArr) throws RemoteException {
        ...
        for (IBinder iBinder : iBinderArr) {
            zzs zzsVarZzdr = zzs.zza.zzdr(iBinder);
            if (zzsVarZzdr == null) {
                Log.e("GoogleCertificates", "iCertData is null, skipping");
            } else {
                hashSet.add(zzsVarZzdr);
            }
        }
        return hashSet;
    }
    ...
    private static boolean zzane() {
        ...
        if (f484qW == null) {
            try {
                zzsj zzsjVarZza = zzsj.zza(f485qX, zzsj.f843Mk, "com.google.android.gms.googlecertificates");
                Log.d("GoogleCertificates", "com.google.android.gms.googlecertificates module is loaded");
                f484qW = zzv.zza.zzdu(zzsjVarZza.zziv("com.google.android.gms.common.GoogleCertificatesImpl"));
            } catch (zzsj.zza e) {
                String strValueOf = String.valueOf("Failed to load com.google.android.gms.googlecertificates: ");
                String strValueOf2 = String.valueOf(e.getMessage());
                Log.e("GoogleCertificates", strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf));
                return false;
            }
        }
        return true;
    ...
    static synchronized Set<zzs> zzanf() {
        ...
        if (f486qY != null) {
            set = f486qY;
        } else if (f484qW != null || zzane()) {
            try {
                com.google.android.gms.dynamic.zzd zzdVarZzasy = f484qW.zzasy();
                if (zzdVarZzasy == null) {
                    Log.e("GoogleCertificates", "Failed to get google certificates from remote");
                    set = Collections.EMPTY_SET;
                } else {
                    f486qY = zza((IBinder[]) com.google.android.gms.dynamic.zze.zzad(zzdVarZzasy));
                    for (int i = 0; i < C0753zzd.f492re.length; i++) {
                        f486qY.add(C0753zzd.f492re[i]);
                    }
                    f486qY = Collections.unmodifiableSet(f486qY);
                    set = f486qY;
                }
            } catch (RemoteException e) {
    ...
    static synchronized Set<zzs> zzang() {
        ...
        if (f487qZ != null) {
            ...
            try {
                com.google.android.gms.dynamic.zzd zzdVarZzasz = f484qW.zzasz();
                if (zzdVarZzasz == null) {
                    Log.d("GoogleCertificates", "Failed to get google release certificates from remote");
                    set = Collections.EMPTY_SET;
                } else {
                    f487qZ = zza((IBinder[]) com.google.android.gms.dynamic.zze.zzad(zzdVarZzasz));
                    f487qZ.add(C0753zzd.f492re[0]);
                    f487qZ = Collections.unmodifiableSet(f487qZ);
                    set = f487qZ;
                }
            } catch (RemoteException e) {
    ...
    static synchronized void zzbq(Context context) {
        if (f485qX != null) {
            ...
            f485qX = context.getApplicationContext();
        }
    }
}
