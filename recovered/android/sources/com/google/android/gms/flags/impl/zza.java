...
public abstract class zza<T> {
    ...
    public static class C0757zza extends zza<Boolean> {
        public static Boolean zza(final SharedPreferences sharedPreferences, final String str, final Boolean bool) {
            return (Boolean) zzui.zzb(new Callable<Boolean>() { // from class: com.google.android.gms.flags.impl.zza.zza.1
    ...
    public static class zzb extends zza<Integer> {
        public static Integer zza(final SharedPreferences sharedPreferences, final String str, final Integer num) {
            return (Integer) zzui.zzb(new Callable<Integer>() { // from class: com.google.android.gms.flags.impl.zza.zzb.1
                @Override // java.util.concurrent.Callable
                /* JADX INFO: renamed from: zzbft, reason: merged with bridge method [inline-methods] */
                public Integer call() {
    ...
    public static class zzc extends zza<Long> {
        public static Long zza(final SharedPreferences sharedPreferences, final String str, final Long l) {
            return (Long) zzui.zzb(new Callable<Long>() { // from class: com.google.android.gms.flags.impl.zza.zzc.1
                @Override // java.util.concurrent.Callable
                /* JADX INFO: renamed from: zzbfu, reason: merged with bridge method [inline-methods] */
                public Long call() {
    ...
    public static class zzd extends zza<String> {
        public static String zza(final SharedPreferences sharedPreferences, final String str, final String str2) {
            return (String) zzui.zzb(new Callable<String>() { // from class: com.google.android.gms.flags.impl.zza.zzd.1
                @Override // java.util.concurrent.Callable
                /* JADX INFO: renamed from: zzaba, reason: merged with bridge method [inline-methods] */
                public String call() {
